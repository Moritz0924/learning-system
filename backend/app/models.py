...
class AgentRun(Base):
    ...
    __table_args__ = (
        ...
        Index(
            ...
            "thread_id",
            unique=True,
            sqlite_where=text("status IN ('running', 'awaiting_approval', 'executing_approval', 'cancellation_requested')"),
            postgresql_where=text("status IN ('running', 'awaiting_approval', 'executing_approval', 'cancellation_requested')"),
        ),
